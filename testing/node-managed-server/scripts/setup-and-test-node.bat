...
REM ============================================================================
echo [Step 1/12] Sourcing ACE environment...
...
REM ============================================================================
REM Step 2: Clean Up Old Node (if exists) and Create Parent Directory
REM ============================================================================
echo [Step 2/12] Cleaning up old node (if exists)...
...
REM ============================================================================
REM Step 3: Create Integration Node
REM ============================================================================
echo [Step 3/12] Creating integration node...
...
REM ============================================================================
REM Step 4: Start Integration Node
REM ============================================================================
echo [Step 4/12] Starting integration node...
...
REM ============================================================================
REM Step 5: Create Integration Servers
REM ============================================================================
echo [Step 5/12] Creating integration servers...
...
REM ============================================================================
REM Step 6: Install Bouncy Castle JARs
REM ============================================================================
echo [Step 6/12] Installing Bouncy Castle JARs at node level...
...
REM ============================================================================
REM Step 7: Restart Node (Required after installing JARs)
REM ============================================================================
echo [Step 7/12] Restarting node to load JARs...
...
REM ============================================================================
REM Step 8: Configure HTTP Ports
REM ============================================================================
echo [Step 8/12] Configuring HTTP ports...
...
REM ============================================================================
REM Step 9: Restart Node to Apply Port Configuration
REM ============================================================================
echo [Step 9/12] Restarting node to apply port configuration...
ibmint stop node %NODE_NAME%
timeout /t 3 /nobreak >nul
ibmint start node %NODE_NAME%
if errorlevel 1 (
...
REM ============================================================================
REM Step 10: Deploy Applications
REM ============================================================================
echo [Step 10/12] Deploying applications...
...
REM ============================================================================
REM Step 11: Verify HTTP Listeners
REM ============================================================================
echo [Step 11/12] Verifying HTTP listeners...
...
REM ============================================================================
REM Step 12: Run Tests
REM ============================================================================
echo [Step 12/12] Running PGP encryption/decryption tests...
echo.
...
curl -X POST http://localhost:%PORT_ENCRYPT%/pgp/encrypt
if errorlevel 1 (
